	...
	(
		...
		impl $fe {
			...
			pub const fn add(&self, rhs: &Self) -> Self {
				Self(<$uint>::from_words($add(self.0.as_words(), rhs.0.as_words())))
			}
			...
			pub const fn sub(&self, rhs: &Self) -> Self {
				Self(<$uint>::from_words($sub(self.0.as_words(), rhs.0.as_words())))
			}

			/// Multiply elements.
			pub const fn mul(&self, rhs: &Self) -> Self {
				Self(<$uint>::from_words($mul(self.0.as_words(), rhs.0.as_words())))
			}
