...
#[cfg(all(feature = "proof-of-authority", feature = "proof-of-stake"))]
compile_error!("features `acurast-node/proof-of-authority` and `acurast-node/proof-of-stake` are mutually exclusive");
