...
impl<T: frame_system::Config> pallet_acurast_hyperdrive_outgoing::WeightInfo for WeightInfo<T> {
	...
	fn send_message(x: u32, ) -> Weight {
		...
		//  Measured:  `311`
		//  Estimated: `14452 + x * (7 ±0)`
		// Minimum execution time: 68_940_000 picoseconds.
		Weight::from_parts(101_795_628, 0)
			.saturating_add(Weight::from_parts(0, 14452))
			// Standard Error: 1_636
			.saturating_add(Weight::from_parts(31_027, 0).saturating_mul(x.into()))
