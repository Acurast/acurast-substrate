...
pub fn setup() {
	...
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), alice_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), bob_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(
		RuntimeOrigin::root(),
		charlie_account_id(),
		100 * UNIT
	));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), dave_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), eve_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), ferdie_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), george_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), henry_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), ivan_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), judy_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), kate_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), luke_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), maria_account_id(), 100 * UNIT));
	assert_ok!(Balances::force_set_balance(RuntimeOrigin::root(), nick_account_id(), 100 * UNIT));
}
