...
pub mod pallet {
	use acurast_common::{
		CommitmentIdProvider, ManagerIdProvider, ManagerLookup, PoolId, Slashable,
	};
	use frame_support::{
		...
		traits::{
			...
			Currency, EnsureOrigin, Get, InspectLockableCurrency, LockIdentifier, OnUnbalanced,
		},
		PalletId, Parameter,
	};
	...
	use sp_core::U256;
	use sp_runtime::{
		traits::{CheckedAdd, One, SaturatedConversion, Saturating, Zero},
