...
impl<T: frame_system::Config> pallet_acurast_marketplace::WeightInfo for WeightInfo<T> {
	...
	fn report() -> Weight {
		...
		//  Measured:  `2573`
		//  Estimated: `67822`
		// Minimum execution time: 135_940_000 picoseconds.
		Weight::from_parts(138_660_000, 0)
	...
	fn propose_matching(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `946 + x * (14901 ±0)`
		//  Estimated: `27048 + x * (1278702 ±0)`
		// Minimum execution time: 2_247_540_000 picoseconds.
		Weight::from_parts(2_265_619_000, 0)
			.saturating_add(Weight::from_parts(0, 27048))
			// Standard Error: 11_987_340
			.saturating_add(Weight::from_parts(2_203_288_582, 0).saturating_mul(x.into()))
	...
	fn finalize_jobs(x: u32, ) -> Weight {
		...
		// Minimum execution time: 89_800_000 picoseconds.
		Weight::from_parts(28_019_994, 0)
			.saturating_add(Weight::from_parts(0, 6443))
			// Standard Error: 82_196
			.saturating_add(Weight::from_parts(69_256_299, 0).saturating_mul(x.into()))
