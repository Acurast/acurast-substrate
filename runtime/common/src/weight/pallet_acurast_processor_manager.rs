...
impl<T: frame_system::Config> pallet_acurast_processor_manager::WeightInfo for WeightInfo<T> {
	...
	fn update_processor_pairings(x: u32, ) -> Weight {
		...
		Weight::from_parts(65_591_377, 0)
			.saturating_add(Weight::from_parts(0, 3655))
			// Standard Error: 15_524
			.saturating_add(Weight::from_parts(10_783_140, 0).saturating_mul(x.into()))
	...
	fn pair_with_manager() -> Weight {
		...
		Weight::from_parts(74_570_000, 0)
			.saturating_add(Weight::from_parts(0, 3655))
	...
	fn recover_funds() -> Weight {
		...
		Weight::from_parts(29_210_000, 0)
	...
	fn heartbeat_with_version() -> Weight {
		...
		//  Measured:  `1246`
		//  Estimated: `15088`
		// Minimum execution time: 116_200_000 picoseconds.
	...
	fn heartbeat_with_metrics(x: u32, ) -> Weight {
		...
		Weight::from_parts(125_061_222, 0)
			.saturating_add(Weight::from_parts(0, 15088))
			// Standard Error: 63_959
			.saturating_add(Weight::from_parts(14_811_927, 0).saturating_mul(x.into()))
	...
	fn set_processor_update_info(x: u32, ) -> Weight {
		...
		Weight::from_parts(24_177_132, 0)
			.saturating_add(Weight::from_parts(0, 3611))
			// Standard Error: 6_875
			.saturating_add(Weight::from_parts(8_857_074, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
