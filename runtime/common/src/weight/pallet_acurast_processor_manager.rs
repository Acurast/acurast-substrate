...
impl<T: frame_system::Config> pallet_acurast_processor_manager::WeightInfo for WeightInfo<T> {
	...
	fn update_processor_pairings(x: u32, ) -> Weight {
		...
		// Minimum execution time: 71_340_000 picoseconds.
		Weight::from_parts(63_813_811, 0)
			.saturating_add(Weight::from_parts(0, 3655))
			// Standard Error: 17_499
			.saturating_add(Weight::from_parts(10_605_245, 0).saturating_mul(x.into()))
	...
	fn heartbeat_with_version() -> Weight {
		...
		//  Measured:  `1246`
		//  Estimated: `15088`
		// Minimum execution time: 112_730_000 picoseconds.
		Weight::from_parts(115_480_000, 0)
	...
	fn heartbeat_with_metrics(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1536 + x * (100 ±0)`
		//  Estimated: `15088 + x * (3678 ±0)`
		// Minimum execution time: 98_820_000 picoseconds.
		Weight::from_parts(123_612_803, 0)
			.saturating_add(Weight::from_parts(0, 15088))
			// Standard Error: 62_659
			.saturating_add(Weight::from_parts(14_256_252, 0).saturating_mul(x.into()))
	...
	fn update_binary_hash() -> Weight {
		...
		Weight::from_parts(11_309_000, 0)
	...
	fn set_processor_update_info(x: u32, ) -> Weight {
		...
		Weight::from_parts(22_423_816, 0)
			.saturating_add(Weight::from_parts(0, 3611))
			// Standard Error: 7_132
			.saturating_add(Weight::from_parts(8_581_829, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
