...
{
	/// Zero scalar.
	pub const ZERO: Self = Self { inner: C::UInt::ZERO };

	/// Multiplicative identity.
	pub const ONE: Self = Self { inner: C::UInt::ONE };
	...
	pub fn random(rng: impl CryptoRng + RngCore) -> Self {
		Self { inner: C::UInt::random_mod(rng, &NonZero::new(Self::MODULUS).unwrap()) }
	}
	...
	C: Curve,
{
	fn conditional_select(a: &Self, b: &Self, choice: Choice) -> Self {
		Self { inner: C::UInt::conditional_select(&a.inner, &b.inner, choice) }
	}
}
	...
	C: Curve,
{
	...
	fn add(self, other: &Self) -> Self {
		Self { inner: self.inner.add_mod(&other.inner, &Self::MODULUS) }
	}
}
	...
	C: Curve,
{
	...
	fn sub(self, other: &Self) -> Self {
		Self { inner: self.inner.sub_mod(&other.inner, &Self::MODULUS) }
	}
}
	...
	C: Curve,
{
	...
	fn neg(self) -> Self {
		Self { inner: self.inner.neg_mod(&Self::MODULUS) }
	}
}
