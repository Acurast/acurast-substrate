...
fn setup_pools() {
	// `MaxPools` differs per runtime: 4 on mainnet, 6 on kusama and rococo. Create only as many
	// of the fixed names as the runtime allows, and skip any that a previous call in the same
