...
impl<T: frame_system::Config> pallet_acurast::WeightInfo for WeightInfo<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(127_870_000, 0)
	...
	fn update_allowed_sources(x: u32, ) -> Weight {
		...
		Weight::from_parts(39_210_000, 0)
			...
			.saturating_add(Weight::from_parts(1_923_591, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn submit_attestation() -> Weight {
		...
		//  Measured:  `174`
		//  Estimated: `12531`
		// Minimum execution time: 15_874_670_000 picoseconds.
		Weight::from_parts(15_957_229_000, 0)
