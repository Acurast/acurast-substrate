...
impl<T: frame_system::Config> pallet_acurast_processor_manager::WeightInfo for WeightInfo<T> {
	...
	fn update_processor_pairings(x: u32, ) -> Weight {
		...
		// Minimum execution time: 75_470_000 picoseconds.
		Weight::from_parts(66_407_931, 0)
			.saturating_add(Weight::from_parts(0, 3655))
			// Standard Error: 17_470
			.saturating_add(Weight::from_parts(12_131_457, 0).saturating_mul(x.into()))
	...
	fn multi_pair_with_manager() -> Weight {
		...
		Weight::from_parts(71_380_000, 0)
			.saturating_add(Weight::from_parts(0, 3655))
			.saturating_add(T::DbWeight::get().reads(7))
	...
	fn heartbeat_with_version() -> Weight {
		...
		Weight::from_parts(118_290_000, 0)
	...
	fn heartbeat_with_metrics(x: u32, ) -> Weight {
		...
		Weight::from_parts(125_439_211, 0)
			.saturating_add(Weight::from_parts(0, 15088))
			// Standard Error: 117_357
			.saturating_add(Weight::from_parts(16_013_173, 0).saturating_mul(x.into()))
	...
	fn set_processor_update_info(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_899_767, 0)
			.saturating_add(Weight::from_parts(0, 3611))
			// Standard Error: 6_983
			.saturating_add(Weight::from_parts(9_424_498, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
