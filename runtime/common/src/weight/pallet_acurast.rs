...
impl<T: frame_system::Config> pallet_acurast::WeightInfo for WeightInfo<T> {
	...
	fn register() -> Weight {
		...
		//  Measured:  `686`
		//  Estimated: `7296`
		// Minimum execution time: 128_129_000 picoseconds.
		Weight::from_parts(130_200_000, 0)
	...
	fn update_allowed_sources(x: u32, ) -> Weight {
		...
		Weight::from_parts(37_050_000, 0)
			...
			.saturating_add(Weight::from_parts(1_662_603, 0).saturating_mul(x.into()))
	...
	fn submit_attestation() -> Weight {
		...
		//  Measured:  `174`
		//  Estimated: `11038`
		// Minimum execution time: 17_427_092_000 picoseconds.
		Weight::from_parts(17_507_362_000, 0)
	...
	fn update_certificate_revocation_list() -> Weight {
		...
		Weight::from_parts(11_449_000, 0)
	...
	fn set_environment(x: u32, ) -> Weight {
		...
		Weight::from_parts(25_559_813, 0)
			.saturating_add(Weight::from_parts(0, 38282))
			// Standard Error: 5_320
			.saturating_add(Weight::from_parts(354_510, 0).saturating_mul(x.into()))
	...
	fn set_environments(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(28_680_000, 0)
			...
			.saturating_add(Weight::from_parts(7_348_105, 0).saturating_mul(x.into()))
			// Standard Error: 243_669
			.saturating_add(Weight::from_parts(6_718_286, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(1))
