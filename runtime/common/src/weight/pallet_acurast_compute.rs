...
impl<T: frame_system::Config> pallet_acurast_compute::WeightInfo for WeightInfo<T> {
	...
	fn create_pool(x: u32, ) -> Weight {
		...
		Weight::from_parts(17_790_313, 0)
			.saturating_add(Weight::from_parts(0, 3490))
			// Standard Error: 2_203
			.saturating_add(Weight::from_parts(37_153, 0).saturating_mul(x.into()))
	...
	fn modify_pool_replace_config(x: u32, ) -> Weight {
		...
		Weight::from_parts(19_408_202, 0)
			.saturating_add(Weight::from_parts(0, 4668))
			// Standard Error: 1_755
			.saturating_add(Weight::from_parts(5_166, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `AcurastCompute::MetricPools` (r:1 w:1)
	...
	fn modify_pool_update_config(x: u32, ) -> Weight {
		...
		Weight::from_parts(23_473_840, 0)
			.saturating_add(Weight::from_parts(0, 4668))
			// Standard Error: 7_174
			.saturating_add(Weight::from_parts(197_847, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(3))
	}
}
